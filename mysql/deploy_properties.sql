...
-- 前端配置，密码使用密文
INSERT INTO `deploy_properties` VALUES ('SERVER_IP', 'FRONTEND', '192.168.0.2', '1');
INSERT INTO `deploy_properties` VALUES ('SERVER_USER', '192.168.0.2', 'root', null);
INSERT INTO `deploy_properties` VALUES ('SERVER_PASS', '192.168.0.2', 'password', null);
INSERT INTO `deploy_properties` VALUES ('DEPLOY_PATH', '192.168.0.2', 'deploy', null);
INSERT INTO `deploy_properties` VALUES ('BACKUP_PATH', '192.168.0.2', 'backup', null);
...
INSERT INTO `deploy_properties` VALUES ('LOG_PATH', '192.168.0.121', 'log/nohup', null);
